					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										<form:form role="form" action="" method="post" enctype="multipart/form-data" modelAttribute="vocabularyAddEntity">
											<div class="form-group">
									         ...
									         <div class="form-group">
									            ...
									            <form:input path="fileAudio" type="file" accept="audio/*" required="required"/>
									         </div>
											<div class="form-group">

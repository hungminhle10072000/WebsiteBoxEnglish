					...
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										<form:form role="form" action="" method="post" enctype="multipart/form-data" modelAttribute="courseEditEntity">
											<form:hidden path = "id" />
											<form:hidden path = "image"/>
											<div class="form-group">
									            <label for=fileImage class="col-form-label">Ảnh mô tả:</label>
									            <form:input onchange="setNameFile(event)" path="fileImage" type="file" accept="image/*"/>
									         </div>
									         <div class="form-group group-file-image">
    											<img alt="Ảnh mô tả" src="<c:url value="/resources/img/${courseEditEntity.image }" />" style="width: 200px; height: 200px">					            
									         </div>
											<div class="form-group">
											...
											<div>
												...
												<button class="btn btn-warning ml-2" type="button"><a href="${pageContext.request.contextPath }/admin/course/editCourse/${courseEditEntity.id}" style=" text-decoration: none; color: white;">Reset</a></button>
